...
<script type="text/javascript">
	...
	function resetValue(){
		...
		$("#gys").combobox("setValue","");
		$("#lxr").val("");
		$("#js").combobox("setValue","");
	...
	function openStudentModifyDialog(){
		...
		$("#fm").form("load",row);
		url="xiaoshou?number="+row.number;
	}
...
<body style="margin: 5px;">
	<table id="dg" title="销售出库" class="easyui-datagrid" fitColumns="true"
	...
	<div id="tb">
		<div>
			<a href="javascript:openStudentModifyDialog()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">出货</a>
		</div>
		<!-- 添加查询条件 -->
		<div>
	...
	<div id="dlg" class="easyui-dialog" style="width: 570px;height: 350px;padding: 10px 20px"
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					<td>客户：</td>
					<td><input type="text" name="kh" id="kh" class="easyui-validatebox" required="true"/></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>联系人：</td>
				...
				<tr>
					...
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>出货时间：</td>
					<td><input class="easyui-datebox" name="chsj" id="chsj" editable="false" /></td>
				</tr>
				   <td>操作员：</td>
						<td><input type="text" name="czy" id="czy" class="easyui-validatebox" required="true"/></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>商品名字：</td>
					<td><input type="text" name="spname" id="spname" class="easyui-validatebox" required="true"readonly/></td>
				</tr>
				<tr>
					<td>编号：</td>
					<td><input type="text" name="id" id="id" class="easyui-validatebox" required="true" readonly /></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>生产地址：</td>
					<td><input type="text" name="cd" id="cd" class="easyui-validatebox" required="true"readonly/></td>
				</tr>
				<tr>
					<td>规格：</td>
					<td><input type="text" name="gg" id="gg" class="easyui-validatebox" required="true"readonly/></td>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>包装：</td>
						<td><input type="text" name="bz" id="bz" class="easyui-validatebox" required="true"readonly/></td>
					
				</tr>
				<tr>
				   <td>单位：</td>
						<td><input type="text" name="dw" id="dw" class="easyui-validatebox" required="true"readonly/></td>
					
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td>单价：</td>
					<td><input type="text" name="dj" id="dj" class="easyui-validatebox" required="true"readonly/></td>
